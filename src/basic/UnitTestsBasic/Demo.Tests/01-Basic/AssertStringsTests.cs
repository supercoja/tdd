...
namespace Demo.Tests
{
    public class AssertStringsTests
    {
        ...
        public void StringsTools_UnirNomes_RetornarNomeCompleto()
        {
            ...
            // Act
            var nomeCompleto = sut.Unir("Thiago", "Almeida");

            // Assert
            Assert.Equal("Thiago Almeida", nomeCompleto);
        }
        ...
        public void StringsTools_UnirNomes_DeveIgnorarCase()
        {
            ...
            // Assert
            Assert.Equal("Thiago Almeida", nomeCompleto, true);
        }
        ...
        public void StringsTools_UnirNomes_DeveConterTrecho()
        {
            ...
            // Assert
            Assert.Contains("ago", nomeCompleto);
        }
        ...
        public void StringsTools_UnirNomes_DeveAcabarCom()
        {
            ...
            // Assert
            Assert.EndsWith("ida", nomeCompleto);
        }
