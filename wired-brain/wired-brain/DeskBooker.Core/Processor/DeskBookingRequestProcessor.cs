...
namespace DeskBooker.Core.Processor
{
    public class DeskBookingRequestProcessor
    {
        ...
        {
            this._deskBookingRepository = deskBookingRepository ?? throw new ArgumentNullException(nameof(deskBookingRepository));
            this._deskRepository = deskRepository ?? throw new ArgumentNullException(nameof(deskRepository));
        }
